...
class _ConsultationFormScreenState extends State<ConsultationFormScreen> {
  ...
  late final TextEditingController _practitionerController;
  ...
  void initState() {
    ...
    _practitionerController = TextEditingController(text: e?.practitionerName ?? '');
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      final consultation = Consultation(
        ...
        practitionerName: _practitionerController.text,
          ...
          child: Column(
            ...
            children: [
              ...
              TextFormField(
                ...
                validator: (v) => (v == null || v.isEmpty) ? 'Praticien requis' : null,
              ),
              const SizedBox(height: 16),
              ...
              if (_filesToUpload.isNotEmpty) ...[
                ...
                ...List.generate(_filesToUpload.length, (i) {
                  return ListTile(
                    ...
                    title: Text(
                      _filesToUpload[i].path.split(Platform.pathSeparator).last,
